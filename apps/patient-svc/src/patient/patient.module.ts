...
import { provideProxyService, AUTH_SERVICE_PROXY_NAME, NUTRITIONIST_SERVICE_PROXY_NAME, DIET_SERVICE_PROXY_NAME, RECORD_SERVICE_PROXY_NAME } from '@backend-evolved/shared';
